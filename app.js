        ...
        U.el('label', { class: 'switch' }, [
          U.el('input', {
            ...
            onchange: (e) => {
              ...
              Toast.ok(e.target.checked ? '已切换深色模式' : '已切换浅色模式');
            }
          }),
          U.el('span', { class: 'slider' })
        ])
      ...
      U.el('div', { class: 'modal-footer' }, [
        U.el('div', { class: 'modal-footer-buttons' }, [
          ...
          U.el('button', { class: 'btn btn-primary', onclick: () => {
            const modal2 = document.querySelector('.modal-backdrop');
            const nickInput = modal2.querySelector('#edit-nickname');
            const bioInput = modal2.querySelector('#edit-bio');
            const chosen = modal2.querySelector('.avatar-option.selected');
            const updated = {
              ...profile,
